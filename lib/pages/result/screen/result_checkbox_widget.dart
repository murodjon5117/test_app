...
class ResultCheckboxWidget extends StatelessWidget {
  final QuestionMainModel model;
  const ResultCheckboxWidget({super.key, required this.model});
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          Color color =
              context.read<ResultCubit>().checkboxColor(model.checkbox![index]);
